...
function LandingPage() {
    ...
    return (
        <div >
          ...
          Our goal is to help foster children find meaningful connections with those that have been foster kids themseleves </p>
          <button class="btn btn-outline-light" type="button" onClick={()=>{console.log("button clicked")}}>Learn More </button>
          </div>
